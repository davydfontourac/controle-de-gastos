...
const SB_ITEMS = [
  {
    group: 'Geral',
    items: [
      { id: 'dashboard', label: 'Dashboard', ic: <LayoutDashboard size={16} />, path: '/dashboard' },
  ...
  { 
    group: 'Conta', 
    items: [
      { id: 'profile', label: 'Perfil', ic: <UserCircle size={16} />, path: '/profile' }
    ] 
  },
];
    ...
    <aside className="A-sb hidden lg:flex">
            ...
            {g.items.map((it) => {
              ...
              return (
                <Link 
                  key={it.id} 
                  to={it.path}
                  className={cn('A-sb-item', isActive && 'active')}
                >
      ...
      <div className="mt-auto pt-4 border-t border-gray-100 dark:border-gray-800 space-y-4">
        <div className="flex items-center justify-between px-2">
          <div className="text-[10px] font-mono text-gray-400 uppercase tracking-widest">Aparência</div>
        ...
        <div className="A-sb-user">
          ...
          <div className="info">
            ...
            <div className="e text-gray-500 dark:text-gray-400 truncate">
              {user?.email}
            </div>
          </div>
          <button 
