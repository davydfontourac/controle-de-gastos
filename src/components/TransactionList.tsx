...
export default function TransactionList({ transactions, isLoading, filters, onDelete, onEdit }: Props) {
  ...
  if (transactions.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 bg-white dark:bg-gray-800 border border-dashed border-gray-300 dark:border-gray-700 rounded-2xl">
